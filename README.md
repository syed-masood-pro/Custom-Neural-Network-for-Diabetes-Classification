...
```
[git clone https://github.com/your-username/Scratch_NN_diabetes.git](https://github.com/syed-masood-pro/Custom-Neural-Network-for-Diabetes-Classification.git)
